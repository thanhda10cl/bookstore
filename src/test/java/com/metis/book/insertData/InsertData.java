...
public class InsertData {
	...
	public void testCreateAddress() {
		...
		// get user admin
		User userAdmin = userRepository.findByUsername("nguyenkhanh2kpi");

		if (Objects.isNull(userAdmin)) {
			log.error(AppConstant.USER_NOT_FOUND + "nguyenkhanh2kpi");
		}
		...
		// get user customer
		User userCustomer = userRepository.findByUsername("thanhda");

		if (Objects.isNull(userCustomer)) {
			log.error(AppConstant.USER_NOT_FOUND + "thanhda");
		}
	...
	public void testCreateCartItem() {
		...
		// get User
		User userKiet = userRepository.findByUsername("thanhda");
	...
	public void testCreateOrder() {
		...
		// get User
		User user = userRepository.findByUsername("thanhda");
	...
	public void createCustomer() {
		...
		User user = User.builder().username("thanhda").password(passwordEncoder.encode("1234"))
				.email("thanhda9@gmail.com").firstName("Da").lastName("Nguyen Thanh")
	...
	public void createAdmin() {
		...
		// Create new Admin
		User user = User.builder().username("nguyenkhanh2kpi").password(passwordEncoder.encode("1234"))
				.email("nguyenkhanh2kpi@gmail.com").firstName("Khanh").lastName("Nguyen Le Quoc")
